...
<body>
        <div class="recordrtc">
            ...
            <br>
            <div>
                <audio controls muted autoplay=""></audio>
            </div>
        </div>
        ...
        <script>
            ...
            var getMediaSrcUrl = function(){
                return fileName;
            }
            var recoredCompleted = function(){
                return recordingPlayer.src !== "";
            }
            recordingDIV.querySelector('button').onclick = function() {
                ...
                if(recordingMedia === 'record-audio') { // When starting audio record
                    ...
                    button.mediaCapturedCallback = function() {
                        ...
                        button.recordingEndedCallback = function(url) {
                            ...
                            recordingPlayer = newAudio;
                            
                            if(newAudio.paused) newAudio.play();
                            newAudio.onended = function() {
                                newAudio.pause();
                                newAudio.src = URL.createObjectURL(button.recordRTC.blob);
                            };
            ...
            function uploadToServer(recordRTC, callback) {
                ...
                makeXMLHttpRequest('record/save.php', formData, function(progress) {
