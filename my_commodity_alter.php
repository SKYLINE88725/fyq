...
<style type="text/css">
	...
	<div class="merchant_entry">
		<div>
            <p align="center" style="margin-top: 8px;font-size: 1.2em;"><font color="#FF0000">可以让讲课的图像最少2，最多5张。</font></p>
			<div class="circle" id="circle">
				<img src="img/my_after_ico1.png" style="margin: 17px 12px;height: 28px;width: 36px;position: relative;">
				<input type="file" name="file" class="webuploader-element-invisible" multiple accept="">
			</div>
		</div>
		<span id="" class="commodity_in_pic">
        		<?php 
		...
		<ul>
        	<li>
                <div class="input-group" style="float: left; margin-left: 10px; width: 90%; margin-top:10px;">
                    ...
                    <input type="text" class="form-control" placeholder="请输入话动标题" name="commodity_title" value="<?php echo $row['tl_name'];?>" >
                </div>            
                ...
                <input class="form-control" type="hidden" alt="推荐此商家手机号" name="commodity_recommend" value="<?php echo $row['item_recommend'];?>">
                <input class="form-control" type="hidden" alt="商家店铺号" name="commodity_class" value="<?php echo $row['tl_class'];?>">
                <input class="form-control" type="hidden" alt="商家手机号" name="commodity_phone" value="<?php echo $member_login;?>">
                <!--经纪人权分销(1980)-->
                <input class="form-control" type="hidden" alt="一级" name="vip1level_1" value="<?php echo $row['level_one_vip1']?>">
                <input class="form-control" type="hidden" alt="二级" name="vip1level_2" value="<?php echo $row['level_two_vip1']?>">
                <input class="form-control" type="hidden" alt="三级" name="vip1level_3" value="<?php echo $row['level_three_vip1']?>">
                <input class="form-control" type="hidden" alt="一级豆" name="vip1point_1" value="<?php echo $row['point_one_vip1']?>">
                <input class="form-control" type="hidden" alt="二级豆" name="vip1point_2" value="<?php echo $row['point_two_vip1']?>">
                <input class="form-control" type="hidden" alt="三级豆" name="vip1point_3" value="<?php echo $row['point_three_vip1']?>">
				<!--合伙人分销(9800)-->
                <input class="form-control" type="hidden" alt="一级" name="vip2level_1" value="<?php echo $row['level_one_vip2']?>">
                <input class="form-control" type="hidden" alt="二级" name="vip2level_2" value="<?php echo $row['level_two_vip2']?>">
                <input class="form-control" type="hidden" alt="三级" name="vip2level_3" value="<?php echo $row['level_three_vip2']?>">
                <input class="form-control" type="hidden" alt="一级豆" name="vip2point_1" value="<?php echo $row['point_one_vip2']?>">
                <input class="form-control" type="hidden" alt="二级豆" name="vip2point_2" value="<?php echo $row['point_two_vip2']?>">
                <input class="form-control" type="hidden" alt="三级豆" name="vip2point_3" value="<?php echo $row['point_three_vip2']?>">
            ...
            <li>
                <div class="input-group" style="float: left; margin-left: 10px; width: 90%; margin-top:10px;">
                    ...
                    <textarea class="form-control" placeholder="请输入活动内容" rows="4" name="commodity_summary" ><?php echo $row['tl_summary'];?></textarea>
                </div>            

			</li>
			<li>
				<div style="float: left; margin-left:10px; width: 90%; margin-top:10px;">
					<label id="spic" class="mui-btn mui-btn-primary">选择店铺图片</label>
					<input type="file" name="file1" class="inputfile" style="display:none;">
                    <div id="feedback" style="float: left; width: 100%;"><img src="<?php echo $row['tc_mainimg'];?>" alt="" style="width:300px;"></div>
            ...
            <li>
            	<div style="margin-left:10px; width:90%;">
                	<div class="input-group" style="width: 100%; float: left; margin-top:10px;">
                        ...
                        <input class="form-control" type="text"  name="commodity_original" value="<?php echo $row['tl_original'];?>" >
                    ...
                    <div class="input-group" style="width: 100%; float: left; margin-top:5px;">
                        ...
                        <input class="form-control" type="text"  name="commodity_supplyprice" value="<?php echo $row['tl_supplyprice'];?>" >
                        <span class="input-inner-label">元</span>
                    </div>
                </div>
			</li>
            <li>
                ...
                <div style="float: left; width: 100%; margin-left: 10px; display:none;" id="closewindow">
                    <div class="input-group" style="width: 202px; float: left; margin-right: 10px;">
                        ...
                        <input class="form-control" type="text" name="commodity_gpsx" id="cgx" value="<?php echo $row['GPS_X'];?>" style="width: 142px;">
                    </div>
                    <div class="input-group" style="width: 202px; float: left; margin-right: 10px;">
                        <span class="input-group-addon">坐标 Y</span>
                        <input class="form-control" type="text" name="commodity_gpsy" id="cgy" value="<?php echo $row['GPS_Y'];?>" style="width: 142px;">
                    </div>
                </div>
                ...
                <div id="address_container" style="display: none;">
                    <div data-toggle="distpicker6" class="area_select" id="distpicker6" style="width:90%; margin-left:10px;">
            ...
            <li>
            	<div class="input-group" style="float: left; margin-left: 10px; width: 90%; margin-top:10px;">
					...
					<input class="form-control" type="text" name="commodity_address" value="<?php echo $row['tl_address'];?>">
				</div>
            </li>
			<li>
            ...
            <li>
            	<div class="input-group" style="float: left; margin-left: 10px; width: 90%; margin-top:10px;">
					...
					<input class="form-control" type="text" name="commodity_pushmsg" placeholder="请输入接单手机号，用“，”号隔开" value="<?php echo $row['pushmsg_id'];?>">
				</div>
            </li>
            <li>
            ...
            <li style="display:none;">
				...
				<textarea id="myEditor" name="commodity_content" style="width:100%;height:300px;"><?php echo $row['tl_detailed'];?></textarea>				</div>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("[name='commodity_refund']").val("<?php echo $row['refund_status'];?>");
 		...
 		$( document ).ready(function(){
			...
			$(".inputfile").change(function(){
				...
				$.ajax( {
					...
					success: function ( data ) {
						$("#feedback").html('<img src="/upload/'+data+'" alt="" style="width:300px;">');
