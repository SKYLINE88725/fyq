...
if (strstr($agent_user,"MicroMessenger")){
	...
	if ($code) {
		...
		header("Location: http://fyq.shengtai114.com/qr_pay.php?openid=$openid&mid=$state");
		exit;
	}
}
...
$query = "SELECT * FROM merchant_entry where me_id = '{$id}'";
...
<div class="scan_pay">
	...
	<div class="scan_pay_content">
		...
		<div class="scan_pay_title">
			<span class="scan_pay_title_span1"><?php echo $row['me_shop'];?></span>
			<span class="scan_pay_title_span2"><?php echo $row['me_address'];?></span>
		</div>
