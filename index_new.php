...
<header class="mui-bar mui-bar-nav" >
  ...
  <div class="foot"> 
    ...
    <a id="miclick" target="_self" class="foot_ico" style="width:17%">
    ...
    <?php
		...
		{
	?> 
    <a href="#" class="foot_ico login_ajax" style="width:17%">
        <span class="mui-icon" style="width:100%;"><img src="img/sss1.png" style="width:20px;"></span><br>
		<span class="mui-tab-label fz13">订单</span>
    </a>
    <a class="foot_ico login_ajax animsition-link" style="width:17%">
