...
//setcookie("member", "13634336777", time()+3600*24*365,"/");
...
<header class="mui-bar mui-bar-nav" >
			<div id="dcontent" class="dcontent mui-col-sm-2 mui-col-xs-2" style="display:none;">
            ...
            <div class="mui-title mui-bar-tab bar-border" style="width:200px;">
				...
				<span class="index_item_list_discount" onClick="index_item_list('new','yes')">热门</span>
			</div>
        ...
        <div class="mui-scroll" style="margin-top:10%">
								<ul id="topfollow" class="mui-table-view mui-grid-view mui-grid-9" style="margin-top: 0;"></ul>
        <div style="width: 100%; background-color: #ebebeb; margin-bottom: 2%;">
	    	<div class="mui-icon icon-volume-high mui-pull-left color-f99c73" style="margin:0 1% 0 3%; line-height: 1.7em; font-size: 1.2em;"></div>
            <div class="dowebok">
			<?php
  ...
  <div class="foot"> 
    <a href="index.php" target="_self" class="foot_ico" style="width:17%;color: #f99c73;">
        <span class="mui-icon mui-icon-home" style="font-size:28px; width:100%;"></span>
		<span class="mui-tab-label">首页</span>
    </a>
    <a href="about_list.php" target="_self" class="foot_ico" style="width:17%">
        <span style="width:100%;"><img src="img/map1.png" style="width:20px;"></span><br>
		<span class="mui-tab-label">附近</span>
    </a>    
    <a href="subscriber.php" target="_self" class="foot_center miclick" style="width:32%;"><img src="img/newhot.png"></a>
    <?php
		if($member_login) 
		{
	?>
    <a href="my_orderall.php" target="_self" class="foot_ico" style="width:17%">
        <span class="mui-icon" style="width:100%;"><img src="img/sss1.png" style="width:20px;"></span><br>
		<span class="mui-tab-label fz13">订单</span>
    </a>
    <a id="miclick" target="_self" href="javascript:void(0);" onclick="return false" class="foot_ico" style="width:17%">
        <span class="mui-icon" style="width:100%;"><img src="img/my1.png" style="width:20px;"></span><br>
    ...
    <?php
		...
		{
	?> 
    <a  href="javascript:void(0);" onclick="return false" target="_self" class="foot_ico login_ajax" style="width:17%">
        <span class="mui-icon" style="width:100%;"><img src="img/sss1.png" style="width:20px;"></span><br>
		<span class="mui-tab-label fz13">订单</span>
    </a>
    <a  href="javascript:void(0);" onclick="return false" target="_self" class="foot_ico login_ajax" style="width:17%">
        <span class="mui-icon" style="width:100%;"><img src="img/my1.png" style="width:20px;"></span>
		<span class="mui-tab-label fz13">我</span>
    </a>
   	<?php
		}
...
function index_item_list(item_cate,return_loding){
    ...
    if (item_cate == "discount_new" || item_cate == "new" ) {
