...
$sql = "INSERT INTO payment_list (pay_member, pay_cate, pay_status, pay_shop, pay_count, pay_price, pay_trade_no, payment_types) VALUES ('{$recommend_phone}', 'scan', '0', '{$recommend_vid}', '1', '{$recommend_price}', '{$trade_no}', '0')";
