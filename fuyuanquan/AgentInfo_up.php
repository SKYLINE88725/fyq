...
$query = "SELECT * FROM agentinfo where ai_id = '{$mid}'";
						...
						<div class="col-xs-12">
							...
							<div class="panel">
								...
								<div class="panel-body">
									省代理:<input type="text" value="<?php echo $row["ai1"]?>" class="" placeholder="省代理" name="ai1" style="margin-bottom: 10px; width: 210px;">
                                    &nbsp;&nbsp;&nbsp;省代理人数:<input type="text" value="<?php echo $row["ai1_cnt"]?>" class="" placeholder="省代理人数" name="ai1_cnt" style="margin-bottom: 10px; width: 210px;">
                                </div>
                                <div class="panel-body">
									市代理:<input type="text" value="<?php echo $row["ai2"]?>" class="" placeholder="市代理" name="ai2" style="margin-bottom: 10px; width: 210px;">
                                    &nbsp;&nbsp;&nbsp;市代理人数:<input type="text" value="<?php echo $row["ai2_cnt"]?>" class="" placeholder="市代理人数" name="ai2_cnt" style="margin-bottom: 10px; width: 210px;">
                                </div>
                                <div class="panel-body">
									区代理:<input type="text" value="<?php echo $row["ai3"]?>" class="" placeholder="区代理" name="ai3" style="margin-bottom: 10px; width: 210px;">
                                    &nbsp;&nbsp;&nbsp;区代理人数:<input type="text" value="<?php echo $row["ai3_cnt"]?>" class="" placeholder="区代理人数" name="ai3_cnt" style="margin-bottom: 10px; width: 210px;">
                                </div>
                                <div class="panel-body">
...
$( document ).ready( function () {
	$( '#distpicker6' ).distpicker( {
		province: '<?php echo $row["ai_province"]?>',
		city: '延吉市',
		district: '河北区'
	} );
} );
