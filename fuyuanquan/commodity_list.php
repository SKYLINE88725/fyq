		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">讲课列表</h3>
					<div class="row">
						<div class="col-xs-12">
							<!-- BASIC TABLE -->
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title"><a href="commodity_add.php<?php if ($sort) {echo "?sort=$sort";}?><?php if ($i_class) {echo "&i_class=$i_class";}?>" target="_self">添加</a></h3>
								</div>
								<div class="panel-body">
									<table class="table">
										...
										if ($i_class) {
											$i_class_sql = " and tl_class = '{$i_class}'";
										} else {
											$i_class_sql = "";
										}
										$perNumber=20;
										$query1 = "SELECT count(*) FROM teacher_list where shop_menu = '{$sort}'{$i_class_sql}";
										$count = mysqli_query($mysqli, $query1);// and item_admin = '{$admin_level}'
										echo $query1;
										echo "<br>";
										...
										$query = "SELECT * FROM teacher_list where shop_menu = '{$sort}'{$i_class_sql} ORDER BY tl_id desc limit {$startCount},{$perNumber}";//and item_admin = '{$admin_level}'//管理员上传的讲课,现在全部显示
										echo $query;
										...
										?>
											<tr id="commodity_<?php echo $row['tl_id'];?>">
												...
												<td>
													<?php if ($row['tc_mainimg']) {?><p><img src="<?php echo $row['tc_mainimg'];?>" alt="" style="width: 120px; height: 120px;"></p><?php }?>
												...
												<a href="commodity_alter.php?sort=<?php echo $row['shop_menu'];?>&id=<?php echo $row['tl_id'];?>" target="_self">修改</a>
