...
if (!strstr($admin_purview,"college")) {
	echo "您没有权限访问此页";
	exit;
}
...
$sql_teacher = mysqli_query($mysqli,"UPDATE teacher_list SET tl_name = '{$tc_title}', tl_pictures = '{$tc_parentFileBox}', tl_price = '{$tc_price}', tl_Sales = '0', tc_province1 = '{$tc_province1}', tc_city1 = '{$tc_city1}', tl_detailed = '{$tc_district1}', tl_summary = '{$tc_summary}', tl_detailed = '{$tc_content}', tc_mainimg = '{$tc_mainimg}', tl_cate = '{$tc_cate}', level_one_vip1 = '{$vip1level1}', level_two_vip1 = '{$vip1level2}', level_three_vip1 = '{$vip1level3}', level_one_vip2 = '{$vip2level1}', level_two_vip2 = '{$vip2level2}', level_three_vip2 = '{$vip2level3}', tl_original = '{$tc_original}', tl_supplyprice = '{$tc_supplyprice}', shop_menu = 'college', index_hot = '{$index_hot}', point_one_vip1 = '{$vip1point1}', point_two_vip1 = '{$vip1point2}', point_three_vip1 = '{$vip1point3}', point_one_vip2 = '{$vip2point1}', point_two_vip2 = '{$vip2point2}', point_three_vip2 = '{$vip2point3}' WHERE tl_id = '{$up_id}'");
