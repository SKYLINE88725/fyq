...
<body>
	...
	<script type="text/javascript">
		...
		$( "#commodity_in" ).click( function () {
			...
			if ( !commodity_title || !commodity_province1 || !commodity_city1 || !commodity_price || !commodity_cate || !commodity_summary || !commodity_content  ) {
				...
				$.post( "post/commodity_add_post.php", {
					...
					function ( data, status ) {
						//$( "[name='commodity_summary']" ).val(data);
						if ( data == "1" ) {
							<?php 
							if ($college_Number) {
						?>
