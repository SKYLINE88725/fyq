...
$query = "SELECT * FROM college_list where cl_id = '{$bid}'";
...
<body>
						...
						<div class="col-xs-12">
							...
							<div class="panel">
								...
								<div class="panel-body">
									<input type="text" class="form-control" placeholder="老师名称" name="busines_title" value="<?php echo $row['cl_name'];?>"><br>
                                    <input type="text" class="form-control" placeholder="手机号" name="busines_phone" value="<?php echo $row['cl_phone'];?>">
	...
	<script type="text/javascript">
		$( document ).ready( function () {
			...
			$("[name='busines_cate']").val("<?php echo $row['cl_cate'];?>");
		} );
	</script>
</body>
