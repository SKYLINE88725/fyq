...
$query = "SELECT * FROM memo_list where me_id = '{$mid}'";
						...
						<div class="col-xs-12">
							...
							<div class="panel">
								...
								<div class="panel-body">
									<input type="text" class="form-control" placeholder="标题" name="memo_title" style="margin-bottom: 10px; width: 650px;" value="<?php echo $row['me_title'];?>">
									<select class="form-control" name="memo_cate" style="margin-bottom: 10px; width: 650px;">
										<option value="10"<?php echo ($row['me_cate'] == '10') ? " selected" : ""?>>公告</option>
										<option value="20"<?php echo ($row['me_cate'] == '20') ? " selected" : ""?>>信息</option>
                                        <option value="30"<?php echo ($row['me_cate'] == '30') ? " selected" : ""?>>买家帮助</option>
                                        <option value="40"<?php echo ($row['me_cate'] == '40') ? " selected" : ""?>>卖家帮助</option>
									</select>
									<textarea id="myEditor" name="memo_content" style="width:100%;height:300px;"><?php echo $row['me_txt'];?></textarea>
